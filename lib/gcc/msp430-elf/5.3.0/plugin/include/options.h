...
#define CL_C          (1U << 0)
#define CL_CXX        (1U << 1)
#define CL_Fortran    (1U << 2)
#define CL_Go         (1U << 3)
#define CL_LTO        (1U << 4)
#define CL_ObjC       (1U << 5)
#define CL_ObjCXX     (1U << 6)
#define CL_LANG_ALL   ((1U << 7) - 1)
...
enum opt_code
{
  ...
  OPT_Wall = 155,                            /* -Wall */
  OPT_Wampersand = 156,                      /* -Wampersand */
  OPT_Warray_bounds = 157,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 158,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 159,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 160,               /* -Wassign-intercept */
  OPT_Wattributes = 161,                     /* -Wattributes */
  OPT_Wbad_function_cast = 162,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 163,                   /* -Wbool-compare */
  OPT_Wbuiltin_macro_redefined = 164,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 165,                     /* -Wc++-compat */
  OPT_Wc__0x_compat = 166,                   /* -Wc++0x-compat */
  /* OPT_Wc__11_compat = 167, */             /* -Wc++11-compat */
  OPT_Wc__14_compat = 168,                   /* -Wc++14-compat */
  OPT_Wc_binding_type = 169,                 /* -Wc-binding-type */
  OPT_Wc90_c99_compat = 170,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 171,                 /* -Wc99-c11-compat */
  OPT_Wcast_align = 172,                     /* -Wcast-align */
  OPT_Wcast_qual = 173,                      /* -Wcast-qual */
  OPT_Wchar_subscripts = 174,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 175,           /* -Wcharacter-truncation */
  OPT_Wchkp = 176,                           /* -Wchkp */
  OPT_Wclobbered = 177,                      /* -Wclobbered */
  OPT_Wcomment = 178,                        /* -Wcomment */
  /* OPT_Wcomments = 179, */                 /* -Wcomments */
  OPT_Wcompare_reals = 180,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 181,        /* -Wconditionally-supported */
  ...
  OPT_Wdate_time = 188,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 189,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 190,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 191,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 192,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 193,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 194,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 195,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 196,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 197,           /* -Wdiscarded-qualifiers */
  ...
  OPT_Wfatal_errors = 208,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 209,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 210,                    /* -Wfloat-equal */
  /* OPT_Wformat = 211, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 212,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 213,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 214,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 215,                /* -Wformat-security */
  OPT_Wformat_signedness = 216,              /* -Wformat-signedness */
  OPT_Wformat_y2k = 217,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 218,             /* -Wformat-zero-length */
  OPT_Wformat_ = 219,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 220,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 221,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 222,           /* -Wfunction-elimination */
  OPT_Wignored_qualifiers = 223,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 224,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 225,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 226,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 227,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 228,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 229, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 230,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 231,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 232,                      /* -Winit-self */
  OPT_Winline = 233,                         /* -Winline */
  OPT_Wint_conversion = 234,                 /* -Wint-conversion */
  OPT_Wint_to_pointer_cast = 235,            /* -Wint-to-pointer-cast */
  OPT_Wintrinsic_shadow = 236,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 237,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 238,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 239,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 240,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 241,               /* -Wjump-misses-init */
  OPT_Wl_ = 242,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 243, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 244,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 245,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 246,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 247,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 248,                     /* -Wlogical-op */
  OPT_Wlong_long = 249,                      /* -Wlong-long */
  OPT_Wmain = 250,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 251,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_transposed_args = 252,         /* -Wmemset-transposed-args */
  ...
  OPT_Wnarrowing = 263,                      /* -Wnarrowing */
  OPT_Wnested_externs = 264,                 /* -Wnested-externs */
  OPT_Wnoexcept = 265,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 266,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 267,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 268,                        /* -Wnonnull */
  /* OPT_Wnormalized = 269, */               /* -Wnormalized */
  ...
  OPT_Wopenmp_simd = 275,                    /* -Wopenmp-simd */
  OPT_Woverflow = 276,                       /* -Woverflow */
  OPT_Woverlength_strings = 277,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 278,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 279,                  /* -Woverride-init */
  OPT_Wp_ = 280,                             /* -Wp, */
  OPT_Wpacked = 281,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 282,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 283,                         /* -Wpadded */
  OPT_Wparentheses = 284,                    /* -Wparentheses */
  OPT_Wpedantic = 285,                       /* -Wpedantic */
  OPT_Wpmf_conversions = 286,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 287,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 288,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 289,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 290,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 291,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 292,                       /* -Wprotocol */
  OPT_Wpsabi = 293,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 294,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 295,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 296,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 297,                /* -Wredundant-decls */
  OPT_Wreorder = 298,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 299,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 300,                    /* -Wreturn-type */
  OPT_Wselector = 301,                       /* -Wselector */
  OPT_Wsequence_point = 302,                 /* -Wsequence-point */
  OPT_Wshadow = 303,                         /* -Wshadow */
  OPT_Wshadow_ivar = 304,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 305,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 306,           /* -Wshift-count-overflow */
  ...
  OPT_Wtabs = 337,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 338,                /* -Wtarget-lifetime */
  ...
  OPT_Wunused_dummy_argument = 355,          /* -Wunused-dummy-argument */
  ...
  OPT_Wuse_without_only = 364,               /* -Wuse-without-only */
  ...
  OPT_Wzerotrip = 374,                       /* -Wzerotrip */
  OPT_Xassembler = 375,                      /* -Xassembler */
  OPT_Xlinker = 376,                         /* -Xlinker */
  OPT_Xpreprocessor = 377,                   /* -Xpreprocessor */
  OPT_Z = 378,                               /* -Z */
  OPT_ansi = 379,                            /* -ansi */
  OPT_aux_info = 380,                        /* -aux-info */
  /* OPT_aux_info_ = 381, */                 /* -aux-info= */
  OPT_auxbase = 382,                         /* -auxbase */
  OPT_auxbase_strip = 383,                   /* -auxbase-strip */
  OPT_c = 384,                               /* -c */
  ...
  OPT_faggressive_function_elimination = 402,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 403,  /* -faggressive-loop-optimizations */
  ...
  OPT_fallow_parameterless_variadic_functions = 416,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 417, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 418, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 419, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 420, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 421, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 422,            /* -fasan-shadow-offset= */
  OPT_fasm = 423,                            /* -fasm */
  OPT_fassociative_math = 424,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 425,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 426,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 427,                   /* -fauto-profile */
  OPT_fauto_profile_ = 428,                  /* -fauto-profile= */
  OPT_fautomatic = 429,                      /* -fautomatic */
  OPT_fbackslash = 430,                      /* -fbackslash */
  OPT_fbacktrace = 431,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 432,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 433,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 434,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 435,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 436,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 437,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 438,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 439,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 440,                        /* -fbuiltin */
  OPT_fbuiltin_ = 441,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 442,                    /* -fcall-saved- */
  OPT_fcall_used_ = 443,                     /* -fcall-used- */
  OPT_fcaller_saves = 444,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 445,       /* -fcanonical-system-headers */
  ...
  OPT_fcheck_pointer_bounds = 449,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 450,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 451,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 452,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 453,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 454,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 455,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 456,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 457,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 458, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 459,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 460,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 461,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 462, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 463,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 464,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 465,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 466,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 467,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 468,                       /* -fcilkplus */
  ...
  OPT_fcond_mismatch = 476,                  /* -fcond-mismatch */
  OPT_fconserve_space = 477,                 /* -fconserve-space */
  OPT_fconserve_stack = 478,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 479,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 480,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 481,                       /* -fconvert= */
  OPT_fcprop_registers = 482,                /* -fcprop-registers */
  OPT_fcray_pointer = 483,                   /* -fcray-pointer */
  OPT_fcrossjumping = 484,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 485,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 486, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 487,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 488,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 489,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 490,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 491,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 492,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 493,                       /* -fdbg-cnt= */
  OPT_fdce = 494,                            /* -fdce */
  OPT_fdebug_cpp = 495,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 496,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 497,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 498,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 499,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 500,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 501, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 502,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 503,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 504,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 505,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 506,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 507,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 508,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 509,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 510,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 511, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 512,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 513,         /* -fdiagnostics-show-caret */
  ...
  OPT_fdump_ada_spec = 522,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 523,             /* -fdump-ada-spec-slim */
  ...
  OPT_fext_numeric_literals = 552,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 553,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 554,                /* -fextern-tls-init */
  OPT_fexternal_blas = 555,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 556, */       /* -fexternal-templates */
  OPT_ff2c = 557,                            /* -ff2c */
  OPT_ffast_math = 558,                      /* -ffast-math */
  OPT_ffat_lto_objects = 559,                /* -ffat-lto-objects */
  ...
  OPT_fforward_propagate = 568,              /* -fforward-propagate */
  OPT_ffp_contract_ = 569,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 570,                   /* -ffpe-summary= */
  ...
  OPT_fgnu_tm = 587,                         /* -fgnu-tm */
  OPT_fgnu_unique = 588,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 589,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 590,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 591,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 592,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 593,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 594,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 595,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 596,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 597,                       /* -fgraphite */
  OPT_fgraphite_identity = 598,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 599,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 600, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 601, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 602, */                     /* -fhelp */
  /* OPT_fhelp_ = 603, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 604,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 605, */                /* -fhonor-std */
  OPT_fhosted = 606,                         /* -fhosted */
  /* OPT_fhuge_objects = 607, */             /* -fhuge-objects */
  OPT_fident = 608,                          /* -fident */
  OPT_fif_conversion = 609,                  /* -fif-conversion */
  OPT_fif_conversion2 = 610,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 611,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 612,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 613,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 614,             /* -fimplicit-templates */
  ...
  OPT_fintrinsic_modules_path_ = 635,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 636,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 637,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 638,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 639,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 640,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 641,              /* -fipa-icf-variables */
  ...
  OPT_fira_hoist_pressure = 651,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 652,              /* -fira-loop-pressure */
  OPT_fira_region_ = 653,                    /* -fira-region= */
  OPT_fira_share_save_slots = 654,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 655,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 656,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 657,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 658,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 659,               /* -fivar-visibility= */
  OPT_fivopts = 660,                         /* -fivopts */
  ...
  OPT_flifetime_dse = 668,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 669,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 670,                    /* -flocal-ivars */
  OPT_floop_block = 671,                     /* -floop-block */
  /* OPT_floop_flatten = 672, */             /* -floop-flatten */
  OPT_floop_interchange = 673,               /* -floop-interchange */
  OPT_floop_nest_optimize = 674,             /* -floop-nest-optimize */
  ...
  OPT_floop_unroll_and_jam = 678,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 679,                      /* -flra-remat */
  OPT_flto = 680,                            /* -flto */
  OPT_flto_compression_level_ = 681,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 682,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 683,                 /* -flto-partition= */
  OPT_flto_report = 684,                     /* -flto-report */
  OPT_flto_report_wpa = 685,                 /* -flto-report-wpa */
  OPT_flto_ = 686,                           /* -flto= */
  OPT_fltrans = 687,                         /* -fltrans */
  OPT_fltrans_output_list_ = 688,            /* -fltrans-output-list= */
  OPT_fmath_errno = 689,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 690,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 691,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 692,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 693,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 694,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 695,                     /* -fmem-report */
  OPT_fmem_report_wpa = 696,                 /* -fmem-report-wpa */
  ...
  /* OPT_fno_vect_cost_model = 713, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 714,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 715,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 716, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 717,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 718,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 719,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 720,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 721,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 722,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 723,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 724,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 725,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 726,                   /* -foffload-abi= */
  OPT_foffload_ = 727,                       /* -foffload= */
  OPT_fomit_frame_pointer = 728,             /* -fomit-frame-pointer */
  OPT_fopenacc = 729,                        /* -fopenacc */
  OPT_fopenmp = 730,                         /* -fopenmp */
  OPT_fopenmp_simd = 731,                    /* -fopenmp-simd */
  OPT_foperator_names = 732,                 /* -foperator-names */
  OPT_fopt_info = 733,                       /* -fopt-info */
  OPT_fopt_info_ = 734,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 735, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 736,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 737,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 738, */           /* -foptional-diags */
  OPT_fpack_derived = 739,                   /* -fpack-derived */
  OPT_fpack_struct = 740,                    /* -fpack-struct */
  OPT_fpack_struct_ = 741,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 742,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 743,              /* -fpcc-struct-return */
  OPT_fpch_deps = 744,                       /* -fpch-deps */
  OPT_fpch_preprocess = 745,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 746,                     /* -fpeel-loops */
  OPT_fpeephole = 747,                       /* -fpeephole */
  OPT_fpeephole2 = 748,                      /* -fpeephole2 */
  OPT_fpermissive = 749,                     /* -fpermissive */
  OPT_fpic = 750,                            /* -fpic */
  OPT_fpie = 751,                            /* -fpie */
  OPT_fplan9_extensions = 752,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 753,                    /* -fplugin-arg- */
  OPT_fplugin_ = 754,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 755,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 756,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 757,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 758,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 759,                   /* -fpreprocessed */
  OPT_fpretty_templates = 760,               /* -fpretty-templates */
  OPT_fprofile = 761,                        /* -fprofile */
  OPT_fprofile_arcs = 762,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 763,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 764,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 765,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 766,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 767,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 768,                 /* -fprofile-report */
  OPT_fprofile_use = 769,                    /* -fprofile-use */
  OPT_fprofile_use_ = 770,                   /* -fprofile-use= */
  OPT_fprofile_values = 771,                 /* -fprofile-values */
  OPT_fprotect_parens = 772,                 /* -fprotect-parens */
  OPT_frandom_seed = 773,                    /* -frandom-seed */
  OPT_frandom_seed_ = 774,                   /* -frandom-seed= */
  OPT_frange_check = 775,                    /* -frange-check */
  OPT_freal_4_real_10 = 776,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 777,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 778,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 779,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 780,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 781,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 782,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 783,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 784,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 785,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 786,                /* -frecord-marker=8 */
  OPT_frecursive = 787,                      /* -frecursive */
  OPT_free = 788,                            /* -free */
  OPT_freg_struct_return = 789,              /* -freg-struct-return */
  /* OPT_fregmove = 790, */                  /* -fregmove */
  OPT_frename_registers = 791,               /* -frename-registers */
  OPT_freorder_blocks = 792,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 793,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 794,              /* -freorder-functions */
  OPT_frepack_arrays = 795,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 796,           /* -freplace-objc-classes */
  OPT_frepo = 797,                           /* -frepo */
  OPT_freport_bug = 798,                     /* -freport-bug */
  OPT_frequire_return_statement = 799,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 800,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 801, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 802,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 803,                    /* -fresolution= */
  OPT_frounding_math = 804,                  /* -frounding-math */
  OPT_frtti = 805,                           /* -frtti */
  OPT_fsanitize_recover = 806,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 807,              /* -fsanitize-recover= */
  OPT_fsanitize_undefined_trap_on_error = 808,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 809,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 810,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 811,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 812,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 813,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 814,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 815,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 816,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 817,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 818,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 819,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 820,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 821,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 822,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 823,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 824,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 825,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 826,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 827, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 828,                /* -fschedule-fusion */
  OPT_fschedule_insns = 829,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 830,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 831,              /* -fsecond-underscore */
  OPT_fsection_anchors = 832,                /* -fsection-anchors */
  /* OPT_fsee = 833, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 834,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 835,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 836, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 837,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 838,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 839,         /* -fsemantic-interposition */
  OPT_fshort_double = 840,                   /* -fshort-double */
  OPT_fshort_enums = 841,                    /* -fshort-enums */
  OPT_fshort_wchar = 842,                    /* -fshort-wchar */
  OPT_fshow_column = 843,                    /* -fshow-column */
  OPT_fshrink_wrap = 844,                    /* -fshrink-wrap */
  OPT_fsign_zero = 845,                      /* -fsign-zero */
  OPT_fsignaling_nans = 846,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 847,               /* -fsigned-bitfields */
  OPT_fsigned_char = 848,                    /* -fsigned-char */
  OPT_fsigned_zeros = 849,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 850,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 851,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 852,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 853,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 854,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 855,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 856, */                 /* -fsquangle */
  OPT_fssa_phiopt = 857,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 858,                   /* -fstack-arrays */
  /* OPT_fstack_check = 859, */              /* -fstack-check */
  OPT_fstack_check_ = 860,                   /* -fstack-check= */
  OPT_fstack_limit = 861,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 862,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 863,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 864,                /* -fstack-protector */
  OPT_fstack_protector_all = 865,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 866,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 867,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 868,                   /* -fstack-reuse= */
  OPT_fstack_usage = 869,                    /* -fstack-usage */
  OPT_fstats = 870,                          /* -fstats */
  OPT_fstdarg_opt = 871,                     /* -fstdarg-opt */
  /* OPT_fstrength_reduce = 872, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 873,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 874,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 875,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 876, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 877,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 878,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 879,                    /* -fsyntax-only */
  OPT_ftabstop_ = 880,                       /* -ftabstop= */
  /* OPT_ftarget_help = 881, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 882,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 883, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 884,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 885,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 886, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 887,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 888,             /* -fthreadsafe-statics */
  OPT_ftime_report = 889,                    /* -ftime-report */
  OPT_ftls_model_ = 890,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 891,               /* -ftoplevel-reorder */
  OPT_ftracer = 892,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 893,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 894,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 895,                  /* -ftrapping-math */
  OPT_ftrapv = 896,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 897,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 898,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 899,                       /* -ftree-ccp */
  OPT_ftree_ch = 900,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 901,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 902,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 903,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 904,                /* -ftree-copyrename */
  OPT_ftree_cselim = 905,                    /* -ftree-cselim */
  OPT_ftree_dce = 906,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 907,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 908,                       /* -ftree-dse */
  OPT_ftree_forwprop = 909,                  /* -ftree-forwprop */
  OPT_ftree_fre = 910,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 911,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 912,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 913,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 914,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 915,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 916,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 917, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 918,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 919,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 920,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 921,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 922,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 923,                   /* -ftree-phiprop */
  OPT_ftree_pre = 924,                       /* -ftree-pre */
  OPT_ftree_pta = 925,                       /* -ftree-pta */
  OPT_ftree_reassoc = 926,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 927, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 928,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 929,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 930,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 931,                      /* -ftree-slsr */
  OPT_ftree_sra = 932,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 933, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 934, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 935,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 936,                /* -ftree-tail-merge */
  OPT_ftree_ter = 937,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 938, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 939,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 940, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 941,                       /* -ftree-vrp */
  OPT_funderscoring = 942,                   /* -funderscoring */
  OPT_funit_at_a_time = 943,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 944,               /* -funroll-all-loops */
  OPT_funroll_loops = 945,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 946,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 947,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 948,             /* -funsigned-bitfields */
  OPT_funsigned_char = 949,                  /* -funsigned-char */
  OPT_funswitch_loops = 950,                 /* -funswitch-loops */
  OPT_funwind_tables = 951,                  /* -funwind-tables */
  OPT_fuse_cxa_atexit = 952,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 953,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 954,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 955,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 956,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 957,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 958,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 959,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 960,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 961, /* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 962, */          /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 963,               /* -fvect-cost-model= */
  OPT_fverbose_asm = 964,                    /* -fverbose-asm */
  /* OPT_fversion = 965, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 966,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 967,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 968,                    /* -fvisibility= */
  OPT_fvpt = 969,                            /* -fvpt */
  /* OPT_fvtable_gc = 970, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 971, */            /* -fvtable-thunks */
  OPT_fvtable_verify_ = 972,                 /* -fvtable-verify= */
  OPT_fvtv_counts = 973,                     /* -fvtv-counts */
  OPT_fvtv_debug = 974,                      /* -fvtv-debug */
  OPT_fweak = 975,                           /* -fweak */
  OPT_fweb = 976,                            /* -fweb */
  /* OPT_fwhole_file = 977, */               /* -fwhole-file */
  OPT_fwhole_program = 978,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 979,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 980,              /* -fworking-directory */
  OPT_fwpa = 981,                            /* -fwpa */
  OPT_fwpa_ = 982,                           /* -fwpa= */
  OPT_fwrapv = 983,                          /* -fwrapv */
  /* OPT_fxref = 984, */                     /* -fxref */
  /* OPT_fzee = 985, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 986,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 987,                      /* -fzero-link */
  OPT_g = 988,                               /* -g */
  OPT_gcoff = 989,                           /* -gcoff */
  OPT_gdwarf = 990,                          /* -gdwarf */
  OPT_gdwarf_ = 991,                         /* -gdwarf- */
  OPT_gen_decls = 992,                       /* -gen-decls */
  OPT_ggdb = 993,                            /* -ggdb */
  OPT_ggnu_pubnames = 994,                   /* -ggnu-pubnames */
  OPT_gno_pubnames = 995,                    /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 996,         /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 997,                 /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 998,                /* -gno-strict-dwarf */
  OPT_gpubnames = 999,                       /* -gpubnames */
  OPT_grecord_gcc_switches = 1000,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1001,                   /* -gsplit-dwarf */
  OPT_gstabs = 1002,                         /* -gstabs */
  OPT_gstabs_ = 1003,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1004,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1005,                        /* -gtoggle */
  OPT_gvms = 1006,                           /* -gvms */
  OPT_gxcoff = 1007,                         /* -gxcoff */
  OPT_gxcoff_ = 1008,                        /* -gxcoff+ */
  OPT_gz = 1009,                             /* -gz */
  OPT_gz_ = 1010,                            /* -gz= */
  OPT_h = 1011,                              /* -h */
  OPT_idirafter = 1012,                      /* -idirafter */
  OPT_imacros = 1013,                        /* -imacros */
  OPT_imultiarch = 1014,                     /* -imultiarch */
  OPT_imultilib = 1015,                      /* -imultilib */
  OPT_include = 1016,                        /* -include */
  OPT_iplugindir_ = 1017,                    /* -iplugindir= */
  OPT_iprefix = 1018,                        /* -iprefix */
  OPT_iquote = 1019,                         /* -iquote */
  OPT_isysroot = 1020,                       /* -isysroot */
  OPT_isystem = 1021,                        /* -isystem */
  OPT_iwithprefix = 1022,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1023,              /* -iwithprefixbefore */
  OPT_l = 1024,                              /* -l */
  OPT_lang_asm = 1025,                       /* -lang-asm */
  OPT_mOs = 1026,                            /* -mOs */
  OPT_masm_hex = 1027,                       /* -masm-hex */
  OPT_mcode_region_ = 1028,                  /* -mcode-region= */
  OPT_mcpu_ = 1029,                          /* -mcpu= */
  OPT_mdata_region_ = 1030,                  /* -mdata-region= */
  OPT_mhwmult_ = 1031,                       /* -mhwmult= */
  OPT_minrt = 1032,                          /* -minrt */
  OPT_mlarge = 1033,                         /* -mlarge */
  OPT_mmcu_ = 1034,                          /* -mmcu= */
  OPT_mrelax = 1035,                         /* -mrelax */
  OPT_msilicon_errata_warn_ = 1036,          /* -msilicon-errata-warn= */
  OPT_msilicon_errata_ = 1037,               /* -msilicon-errata= */
  OPT_msim = 1038,                           /* -msim */
  OPT_msmall = 1039,                         /* -msmall */
  OPT_mwarn_mcu = 1040,                      /* -mwarn-mcu */
  OPT_n = 1041,                              /* -n */
  OPT_no_canonical_prefixes = 1042,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1043,              /* -no-integrated-cpp */
  ...
  OPT_static_libasan = 1080,                 /* -static-libasan */
  OPT_static_libgcc = 1081,                  /* -static-libgcc */
  OPT_static_libgfortran = 1082,             /* -static-libgfortran */
  OPT_static_libgo = 1083,                   /* -static-libgo */
  OPT_static_liblsan = 1084,                 /* -static-liblsan */
  OPT_static_libmpx = 1085,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1086,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1087,               /* -static-libstdc++ */
  OPT_static_libtsan = 1088,                 /* -static-libtsan */
  OPT_static_libubsan = 1089,                /* -static-libubsan */
  /* OPT_std_c__03 = 1090, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1091, */                /* -std=c++0x */
  OPT_std_c__11 = 1092,                      /* -std=c++11 */
  OPT_std_c__14 = 1093,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1094, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1095, */                /* -std=c++1y */
  OPT_std_c__1z = 1096,                      /* -std=c++1z */
  ...
  OPT_std_gnu__14 = 1112,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1113, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1114, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1115,                    /* -std=gnu++1z */
