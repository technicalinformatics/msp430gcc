...
#
# RCS: @(#) $Id: tclConfig.sh.in,v 1.4 2015/01/08 10:02:20 nickc Exp $
...
# installed.
TCL_PREFIX='/opt/redhat/msp430-15r1-105/i686-redhat-linux'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/redhat/msp430-15r1-105/i686-redhat-linux'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/es/build/msp430-15r1/105/i686-redhat-linux/X-i686-redhat-linux-x-msp430-elf/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/redhat/msp430-15r1-105/i686-redhat-linux/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/redhat/msp430-15r1-105/i686-redhat-linux/include'
...
# compiled.
TCL_SRC_DIR='/opt/redhat/msp430-15r1-105/sources/tools/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/redhat/msp430-15r1-105/i686-redhat-linux/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/es/build/msp430-15r1/105/i686-redhat-linux/X-i686-redhat-linux-x-msp430-elf/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/redhat/msp430-15r1-105/i686-redhat-linux/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/es/build/msp430-15r1/105/i686-redhat-linux/X-i686-redhat-linux-x-msp430-elf/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/redhat/msp430-15r1-105/i686-redhat-linux/lib/libtclstub8.4${TCL_DBGX}.a'
